...
New training runs default to **MobileNetV3 Small**, using torchvision ImageNet weights.
...
and export; resume rejects a pyramid mismatch. No accuracy or CPU latency gain
is assumed until the new model is trained and benchmarked.
