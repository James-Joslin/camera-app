...
- C# OpenVINO detector endpoint plus reproducible FP16/INT8 conversion, calibration, and benchmark tooling.
...
- Next.js frontend and ASP.NET Core API service scaffolds.
...
- Mounted optimized models read-only into the non-root C# API production container.
